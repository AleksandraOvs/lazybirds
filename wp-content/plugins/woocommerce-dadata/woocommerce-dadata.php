...
final class WooCommerce_DaData {
	...
	public function WooCommerce_DaData_js() {
        ...
        wp_register_script( 
            ...
            /*plugins_url( '/custom/assets/js/jquery.suggestions.min.js', __FILE__ ),*/'https://cdn.jsdelivr.net/npm/suggestions-jquery@21.12.0/dist/js/jquery.suggestions.min.js',
            array( 'jquery' )
        );
