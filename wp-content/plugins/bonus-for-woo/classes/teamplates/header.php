...
<table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
    <tbody><tr><td align="center" valign="top">
                ...
                <table  border="0" cellpadding="0" cellspacing="0" width="600" style="background-color:#ffffff;border:1px solid #dedede;border-radius:3px">
                    <tbody><tr><td align="center" valign="top">
               <table  border="0" cellpadding="0" cellspacing="0" width="600" style="background-color:{woocommerce_email_base_color};border-bottom-style:none;border-bottom-width:0;border-radius:3px 3px 0 0;color:#ffffff;font-family:\'helvetica neue\' , \'helvetica\' , \'roboto\' , \'arial\' , sans-serif;font-weight:bold;line-height:100%;vertical-align:middle"><tbody><tr>
                        <td id="header_wrapper" style="display:block;padding:36px 48px 36px 48px">
        ...
        <div id="5b5e64daa4b5370bbody_content_inner" style="color:{woocommerce_email_text_color};font-family:\'helvetica neue\' , \'helvetica\' , \'roboto\' , \'arial\' , sans-serif;font-size:14px;line-height:150%;text-align:left">