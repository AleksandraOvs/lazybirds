...
<?php else : ?>
	...
	У тебя пока не было ни одного заказа. </p>
<p style="text-align: center; margin:0;">Давай это исправим:)</p>
<a href="<?php echo site_url('shop') ?>" class="button" style="margin: 50px auto 0; display: block">К покупкам</a>
