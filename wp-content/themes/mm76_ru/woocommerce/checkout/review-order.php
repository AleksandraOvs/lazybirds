...
<div class="checkout-totals">
	<p><?php esc_html_e( 'Subtotal', 'woocommerce' ); ?>:&nbsp;</p><span><?php wc_cart_totals_subtotal_html(); ?></span>
		...
		<div class="order-total">
			<p><?php esc_html_e( 'Total', 'woocommerce' ); ?>:&nbsp;</p><span><?php wc_cart_totals_order_total_html(); ?></span>
		</div>
